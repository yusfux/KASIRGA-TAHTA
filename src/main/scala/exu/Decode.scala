...
object DecodeConfig {
  ...
  // i32
   ...
   ANDN             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   CLZ              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   CPOP             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   CTZ              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   MAX              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   MAXU             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   MIN              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   MINU             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   ORC_B            -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   ORN              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   ROL              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   ROR              -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   SEXT_B           -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   SEXT_H           -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   XNOR             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),

   REV8_RV32        -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   RORI_RV32        -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   ZEXT_H_RV32      -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),

   BCLR             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   BEXT             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   BINV             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   BSET             -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),

   BCLRI_RV32       -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   BEXTI_RV32       -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   BINVI_RV32       -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   BSETI_RV32       -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   ...
   SH1ADD           -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   SH2ADD           -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
   SH3ADD           -> Seq(op.e(ALUOp.toString(ALUOp.add))    ,ExEngine.toString(ExEngine.alu),WRITE_RF_1,OPERAND1_REG, OPERAND2_IMM  ,WAKEUP_1,IS_JAL_0,IS_BRANCH_0,TYPE_INT),
