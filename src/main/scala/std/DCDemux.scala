...
/*
@note DCDemux is a demultiplexer from a single numInputs ports input interface to numInterfaces number of output interfaces each having numInputs number of ports.
